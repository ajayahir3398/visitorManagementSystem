...
const validatePayMaintenance = [
  body('tempBillId')
    .notEmpty()
    .withMessage('tempBillId is required')
    .isInt()
    .withMessage('tempBillId must be an integer'),
  body('paymentMode')
    .notEmpty()
    .withMessage('paymentMode is required')
    .isIn(['ONLINE', 'UPI', 'CASH', 'CHEQUE'])
...
const validateAdminPay = [
  body('billType')
    .notEmpty()
    .withMessage('billType is required')
    .isIn(['TEMP', 'FINAL'])
    .withMessage('billType must be TEMP or FINAL'),
  body('billId')
    .notEmpty()
    .withMessage('billId is required')
    .isInt()
    .withMessage('billId must be an integer'),
  body('paymentMode')
    .notEmpty()
    .withMessage('paymentMode is required')
    .isIn(['ONLINE', 'UPI', 'CASH', 'CHEQUE'])
