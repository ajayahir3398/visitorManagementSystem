export default {
  '/api/v1/maintenance-plans': {
    get: {
      ...
      description:
        "Retrieves all maintenance plans (MONTHLY/YEARLY) for the authenticated user's society. Accessible by SOCIETY_ADMIN and RESIDENT.",
      security: [{ bearerAuth: [] }],
      parameters: [
        {
          name: 'isActive',
    ...
    post: {
      ...
      description:
        'Creates a new maintenance plan (MONTHLY or YEARLY) for the society. Only one plan per type per society is allowed.',
      security: [{ bearerAuth: [] }],
      requestBody: {
        required: true,
        content: {
